...
sendNotification:function(a,b,c){if(this.hasObserverKey(a)){for(var b=new Notification(a,b,c),a=this.observers[a],c=a.length,d,e=[];-1<--c;)d=a[c],e.unshift(d);for(c=e.length;-1<--c;)d=e[c],d.sendNotification(b)}}});
